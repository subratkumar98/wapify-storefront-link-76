...
import { BarChart, TrendingUp, Users, ShoppingBag, Eye, Crown, Calendar, Download, Filter, ArrowLeft, RefreshCw } from 'lucide-react';
...
const AnalyticsSection: React.FC<AnalyticsSectionProps> = ({ userPlan, onBack }) => {
